...
Sequelize is a promise-based Node.js ORM for Postgres, MySQL, SQLite, Microsoft SQL Server and Oracle. It features solid transaction support, relations, read replication and more.
