...
function underscore(str) {
  return noCase.noCase(str, {delimiter : '_'});
}
    ...
    getComplexKeys(attributes).forEach(attribute => {
      ...
      if (_.isPlainObject(attributes[attribute])
        && !(rawAttribute && (
          ...
          || (rawAttribute.type && (rawAttribute.type instanceof DataTypes.JSON || rawAttribute.type.key === 'JSON'))))) { // Prevent renaming of HSTORE & JSON fields
