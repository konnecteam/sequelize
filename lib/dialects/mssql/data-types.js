...
module.exports = BaseTypes => {
  ...
  BaseTypes.JSON.types.mssql = false;
  ...
  DATE.prototype.toSql = function toSql() {
    if (process.env.SEQ_MSSQL_LEGACY_DATE && process.env.SEQ_MSSQL_LEGACY_DATE.trim() === 'true') {
      return 'DATETIME';
    } else {
  ...
  /**
   * If the dates are not DateTimeOffset we set them like this 
   * */
  if (process.env.SEQ_MSSQL_LEGACY_DATE && process.env.SEQ_MSSQL_LEGACY_DATE.trim() === 'true') {
