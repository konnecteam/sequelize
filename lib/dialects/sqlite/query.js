  ...
  _collectModels(include, prefix) {
    ...
    if (include) {
      for (const _include of include) {
        ...
        if ((!_include.include || !_include.include.length) && _include.association && _include.association.associationType === 'BelongsToMany') {
          // Special case : belongsToMany and link table
          _.merge(ret, this._collectModels(Object.keys(_include.includeMap).map(f => _include.includeMap[f]), key));
        } else if (_include.include) {
